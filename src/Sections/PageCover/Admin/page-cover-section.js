...
export default class PageCoverSection extends Section {
     ...
     * @param {Api}           api
     */
    constructor (uploadId, eyebrow, heading, thumbUrl, api) {
        super()
    ...
    static fromObject (data, api) {
        if (
            ...
            throw new Error('Invalid PageCoverSection data')
        return new PageCoverSection(
            data.uploadId,
            data.eyebrow,
            data.heading,
    ...
    static createEmpty (api) {
        return new PageCoverSection(null, '', '', null, api)
    }
    ...
    static preview () {
        ...
        root.append(bar(30, 'sp-bar sp-bar--eyebrow'), bar(68, 'sp-bar sp-bar--heading'))
        return root
    }
    ...
    #build () {
        ...
        root.append(this.#addButton, this.#pickedPreview, eyebrowLabel, headingLabel)
        return root
    }
