...
export default class PageEditor {
    ...
    constructor (page, api, router, sectionFactory, loader, notifier) {
        ...
        this.#sectionsContainer.addEventListener('imageloading', ()    => this.#onImageLoading())
        this.#sectionsContainer.addEventListener('imageloaded',  ()    => this.#onImageLoaded())
    ...
    /** @type {boolean} */
    #isSaving = false
    /** @type {import('/js/admin/loader/loading-handle.js').default | null} */
    #imageLoadingHandle = null
    ...
    #refreshSaveButton () {
        this.#saveButton.disabled = this.#isSaving || this.#pendingImages > 0
    }

    #onImageLoading () {
        this.#pendingImages++
        if (this.#pendingImages === 1)
            this.#imageLoadingHandle = this.#loader.start('images')
    ...
    #onImageLoaded () {
        ...
        if (this.#pendingImages === 0) {
            this.#imageLoadingHandle?.stop()
            this.#imageLoadingHandle = null
        }
        this.#refreshSaveButton()
    }
